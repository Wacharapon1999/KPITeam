...
const Sidebar = () => {
  ...
  return (
    <nav className="w-64 bg-gradient-to-br from-brand-green to-[#005a35] min-h-screen text-white fixed left-0 top-0 z-50 shadow-xl hidden md:flex flex-col">
      ...
      <div className="p-4 border-t border-white/10 space-y-2">
        <div className="flex items-center gap-2 px-4 py-2 text-xs text-white/80 bg-black/20 rounded-lg">
        ...
        <button 
          ...
          className="flex items-center gap-3 px-6 py-3 w-full hover:bg-brand-red/20 text-red-100 hover:text-white transition-colors rounded-lg"
        >
